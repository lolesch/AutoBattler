...
namespace Code.Data.Items.Weapon
{
    ...
    public sealed class WeaponConfig : ItemConfig
    {
        ...
        [field: Tooltip("Condition that must be met for this weapon to fire as a mid-chain payload.")]
        ...
        [field: Tooltip("Threshold value for HealthBelow and ResourceFull conditions (0–1).")]
